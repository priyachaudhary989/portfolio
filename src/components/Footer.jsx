    ...
    <footer className="relative border-t border-white/10 mt-10">
      <div className="section-container !py-14">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10">
          <div>
            <h3 className="text-2xl font-bold gradient-text mb-4">Priya Chaudhary</h3>
            <p className="text-muted text-sm leading-relaxed mb-5">
              Full Stack Developer building modern, scalable, and beautiful web applications.
            </p>
        ...
        <div className="border-t border-white/10 mt-12 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-muted text-xs sm:text-sm text-center">
            © {year} Priya Chaudhary. All rights reserved.
          </p>
